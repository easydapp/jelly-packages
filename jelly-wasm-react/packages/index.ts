...
export const execute_code: (
    ...
    args: [string, any][],
    debug: boolean,
) => Promise<any | undefined> = _execute_code;
...
export const find_all_anchors: (
    components: LinkComponent[],
    debug: boolean,
) => Promise<CheckedAnchors> = _find_all_anchors;
export const find_origin_codes: (
    components: LinkComponent[],
    fetch: ApisCheckFunction,
    debug: boolean,
) => Promise<CheckedCodeItem[]> = _find_origin_codes;
export const find_template_origin_codes: (
    nodes: TrimmedNode[],
    debug: boolean,
) => Promise<CheckedCodeItem[]> = _find_template_origin_codes;
